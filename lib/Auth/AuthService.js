...
class AuthService {
	...
	*/
	static onLogout(callback){
		...
		_$LogoutControllerφ.default.onLogout(callback);
	...
	*/
	static onFetchAuthenticated(callback){
		...
		_$PersonalAccessTokenφ.default.onFetchAuthenticated(callback);
	...
	*/
	static onSessionDestroyed(callback){
		...
		_$Driverφ.default.onSessionDestroyed(callback);
	...
	*/
	static onSuccessfulAttempt(callback){
		...
		_$Driverφ.default.onSuccessfulAttempt(callback);
