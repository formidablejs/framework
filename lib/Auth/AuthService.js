...
class AuthService {
	...
	*/
	...
	@param {Function} callback
	*/
	static onEmailVerified(callback){
		
		$3.default.onEmailVerified(callback);
	...
	@param {Function} callback
	*/
	static onRequestEmailVerificationUrl(callback){
		
		$3.default.onRequestEmailVerificationUrl(callback);
	...
	@param {Function} callback
	*/
	static onRequestForgotPasswordUrl(callback){
		
		$3.default.onRequestForgotPasswordUrl(callback);
	...
	@param {Function} callback
	*/
	static onUpdatePassword(callback){
		
		$3.default.onUpdatePassword(callback);
