...
const $5 = Symbol.for('#__init__'), $10 = Symbol.for('#__initor__'), $11 = Symbol.for('#__inited__'), $6 = Symbol.for('#__hooks__');
...
class Auth {
	...
	*/
	constructor(user = null,abilities = null,driverManager){
		...
		for (let $7 = 0, $8 = Object.keys(user), $9 = $8.length, key, value; $7 < $9; $7++){
			key = $8[$7];value = user[key];
