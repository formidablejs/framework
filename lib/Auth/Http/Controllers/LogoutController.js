...
/*body*/
var _$LogoutRequestφ = requireDefault$__(require('../Requests/LogoutRequest'/*$path$*/));
...
class LogoutController extends _$Controllerφ.default {
	static [Ψ__init__](){
		decorate$__([_$useφ.αuse.bind([_$LogoutRequestφ.default])],this.prototype,'logout',null);
