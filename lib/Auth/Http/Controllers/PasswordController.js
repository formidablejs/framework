...
/*body*/
var _$ForgotPasswordRequestφ = requireDefault$__(require('../Requests/ForgotPasswordRequest'/*$path$*/));
var _$ResetPasswordRequestφ = requireDefault$__(require('../Requests/ResetPasswordRequest'/*$path$*/));
...
class PasswordController extends _$Controllerφ.default {
	static [Ψ__init__](){
		decorate$__([_$useφ.αuse.bind([_$ForgotPasswordRequestφ.default])],this.prototype,'forgot',null);
		decorate$__([_$useφ.αuse.bind([_$ResetPasswordRequestφ.default])],this.prototype,'reset',null);
