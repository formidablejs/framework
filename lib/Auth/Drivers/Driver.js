...
class Driver {
	...
	*/
	async getPersonalAccessToken(token = null){
		...
		return await _$PersonalAccessTokenφ.default.find((token !== null && token !== undefined) ? token : this.request.bearerToken());
	}
	...
	*/
	async destroy(token = null,body = new Object){
		...
		return await _$PersonalAccessTokenφ.default.destroy((token !== null && token !== undefined) ? token : this.request.bearerToken());
	}
