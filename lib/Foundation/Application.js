...
class Application {
	...
	*/
	constructor(root){
		...
		settings.port = ((φ = Number(process.env.FORMIDABLE_PORT)) != null) ? (φ) : 3000;
	}
	...
	*/
	async initiate(kernel,returnMode = false){
		...
		if (!(_$isEmptyφ.default(_$Databaseφ.default))) {
			
			_$Databaseφ.default.context = 'Database';
			
			this.context.inject(_$Databaseφ.default);
		};
