...
var $13 = requireDefault$__(require('../Support/ServiceResolver'/*$path$*/));
var $14 = requireDefault$__(require('../Support/Helpers/isEmpty'/*$path$*/));
var $15 = requireDefault$__(require('../Http/Kernel'/*$path$*/));
var $16 = requireDefault$__(require('../Database/Migration'/*$path$*/));
var $17 = requireDefault$__(require('../Http/Router/Route'/*$path$*/));
var $18 = requireDefault$__(require('../Database/Seeder'/*$path$*/));
var $19 = requireDefault$__(require('../Support/Helpers/version'/*$path$*/));
const settings = {
	config: null,
	console: null,
	environment: null,
...
class Application {
	[$__patch__$]($$ = {}){
		var $20;
		($20 = $$.bindings) !== undefined && (this.bindings = $20);
		($20 = $$.config) !== undefined && (this.config = $20);
		($20 = $$.hooks) !== undefined && (this.hooks = $20);
		($20 = $$.plugins) !== undefined && (this.plugins = $20);
		($20 = $$.root) !== undefined && (this.root = $20);
		($20 = $$.handler) !== undefined && (this.handler = $20);
		($20 = $$.context) !== undefined && (this.context = $20);
		($20 = $$.serverConfig) !== undefined && (this.serverConfig = $20);
	...
	[$__init__$]($$ = null,deep = true){
		...
		this.serverConfig = ($$ && ($21 = $$.serverConfig) !== undefined) ? ($21) : {
	...
	*/
	constructor(root){
		...
		settings.console = new $3.Application('Formidable Framework',$19.default());
		settings.environment = new $10.default(root);
		settings.migration = new $16.default;
		settings.seeder = new $18.default;
	...
	resolve(){
		...
		if (resolvers && (resolvers instanceof Array)) {
			...
			for (let $23 = 0, $24 = iter$__(resolvers), $26 = $24.length; $23 < $26; $23++) {
				let resolver = /**@type {ServiceResolver}*/($24[$23]);
				resolver = new ((($25 = resolver.default) != null) ? ($25) : resolver)(this);
				
				resolver.boot();
				resolver.register();
				
				$22.push((resolver.context && Array.isArray(resolver.context)) && (
					
					resolver.context.forEach(function(context) {
						
						return self.context.inject(context);
					})
				));
			};
			return $22;
