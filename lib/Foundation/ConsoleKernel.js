...
/*body*/
var $1 = require('./Console/Commands/MakeCrudCommand'/*$path$*/);
var $2 = require('./Console/Commands/SessionPruneExpiredCommand'/*$path$*/);
var $3 = require('./Console/Commands/PackagePublishCommand'/*$path$*/);
var $4 = require('./Console/Commands/ConfigCacheCommand'/*$path$*/);
var $5 = require('./Console/Commands/ConfigClearCommand'/*$path$*/);
var $6 = require('./Console/Commands/DbSeedCommand'/*$path$*/);
var $7 = require('./Console/Commands/DownCommand'/*$path$*/);
var $8 = require('./Console/Commands/EnvironmentCommand'/*$path$*/);
var $9 = require('./Console/Commands/GenerateKeyCommand'/*$path$*/);
var $10 = require('./Console/Commands/MakeCommandCommand'/*$path$*/);
var $11 = require('./Console/Commands/MakeConfigCommand'/*$path$*/);
var $12 = require('./Console/Commands/MakeControllerCommand'/*$path$*/);
...
class ConsoleKernel {
	...
	get default(){
		...
		return [
			...
			// env command
			$8.EnvironmentCommand,
			
			// key command
			$9.GenerateKeyCommand,
			
			// shell command
			$27.ShellCommand,
			
			// config commands
			$4.ConfigCacheCommand,
			$5.ConfigClearCommand,
			
			// serve command
			$26.ServeCommand,
			
			// session command
			$2.SessionPruneExpiredCommand,
			
			// package commands
			$3.PackagePublishCommand,
			
			// make commands
			$10.MakeCommandCommand,
			$11.MakeConfigCommand,
			$12.MakeControllerCommand,
			$1.MakeCrudCommand,
