...
/*body*/
var _$PackagePublishCommandφ = require('./Console/Commands/PackagePublishCommand'/*$path$*/);
var _$ConfigCacheCommandφ = require('./Console/Commands/ConfigCacheCommand'/*$path$*/);
var _$ConfigClearCommandφ = require('./Console/Commands/ConfigClearCommand'/*$path$*/);
var _$DbSeedCommandφ = require('./Console/Commands/DbSeedCommand'/*$path$*/);
...
var _$MakeCommandCommandφ = require('./Console/Commands/MakeCommandCommand'/*$path$*/);
...
var _$ServeCommandφ = require('./Console/Commands/ServeCommand'/*$path$*/);
var _$ShellCommandφ = require('./Console/Commands/ShellCommand'/*$path$*/);
...
class ConsoleKernel {
	...
	get default(){
		...
		return [
			// db commands
						_$DbSeedCommandφ.DbSeedCommand,
			...
			// shell command
			_$ShellCommandφ.ShellCommand,
			
			// config commands
			_$ConfigCacheCommandφ.ConfigCacheCommand,
			_$ConfigClearCommandφ.ConfigClearCommand,
			
			// serve command
			_$ServeCommandφ.ServeCommand,
			
			// package commands
			_$PackagePublishCommandφ.PackagePublishCommand,
			
			// make commands
			_$MakeCommandCommandφ.MakeCommandCommand,
