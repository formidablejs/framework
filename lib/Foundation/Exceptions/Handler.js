...
const $7 = Symbol.for('#__init__'), $12 = Symbol.for('#__initor__'), $13 = Symbol.for('#__inited__'), $8 = Symbol.for('#__hooks__');
	...
	*/
	shouldReport(error){
		...
		if (!($4.default(this.dontReport)) && $3.default(this.dontReport)) {
			...
			for (let $9 = 0, $10 = iter$__(this.dontReport), $11 = $10.length; $9 < $11; $9++) {
				let exception = $10[$9];
