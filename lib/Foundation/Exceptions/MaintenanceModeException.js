...
class MaintenanceModeException extends $1.default {
	...
	[$2]($$ = null,deep = true){
		...
		this.response = ($$ && ($9 = $$.response) !== undefined) ? ($9) : 'Service Unavailable';
		this.status = ($$ && ($9 = $$.status) !== undefined) ? ($9) : 503;
		
	}
};
exports.default = MaintenanceModeException; MaintenanceModeException[$2]();
