...
class MaintenanceModeException extends _$HttpExceptionφ.default {
	static [Ψ__init__](){
	...
	[Ψ__init__]($$ = null){
		...
		this.response = ($$ && (vφ = $$.response) !== undefined) ? (vφ) : 'Service Unavailable';
		this.status = ($$ && (vφ = $$.status) !== undefined) ? (vφ) : 503;
		
	}
};
exports.default = MaintenanceModeException; MaintenanceModeException[Ψ__init__]();
