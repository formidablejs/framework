...
const $4 = Symbol.for('#__init__'), $8 = Symbol.for('#__initor__'), $9 = Symbol.for('#__inited__'), $5 = Symbol.for('#__hooks__');
...
class Language {
	...
	*/
	get(path,default$){
		...
		const output = (($7 = $1.default(this.lang.packs,("" + (this.lang.locale) + "." + path))) != null) ? ($7) : $1.default(this.lang.packs,("" + (this.lang.fallback_locale) + "." + path));
