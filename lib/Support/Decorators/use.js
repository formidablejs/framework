...
var $5 = requireDefault$__(require('../../Database/Model'/*$path$*/));
...
function αuse(target,key,descriptor){
	...
	descriptor.value = async function() {
		...
		await definition.forEach(function(object,key) {
			...
			if ($5.default.isPrototypeOf(object)) {
				...
				if (!($1.default(param))) {
					...
					const column = (param.split(':')[1] != null) ? param.split(':')[1] : (((($8 = object.routeKeyName) != null) ? ($8) : 'id'));
