...
function config(notation,default$ = null){
	...
	const location = _$envφ.default('PREFER_DISTRIBUTED_CACHE',false) ? _$pathφ.default.join(process.cwd(),'.formidable','config.json') : _$pathφ.default.join(process.cwd(),'bootstrap','cache','config.json');
