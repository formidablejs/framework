...
const $3 = Symbol.for('#__init__'), $9 = Symbol.for('#__initor__'), $10 = Symbol.for('#__inited__'), $4 = Symbol.for('#__hooks__');
...
class FileCollection {
	...
	[$3]($$ = null){
		var $5;
		this._object = ($$ && ($5 = $$._object) !== undefined) ? ($5) : [];
		this._conditions = ($$ && ($5 = $$._conditions) !== undefined) ? ($5) : [];
	...
	*/
	get(){
		...
		for (let $6 = 0, $7 = iter$__(this._conditions), $8 = $7.length; $6 < $8; $6++) {
			let condition = /**@type {{ key: String, value: any }}*/($7[$6]);
