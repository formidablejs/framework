...
const $15 = Symbol.for('#session'), $16 = Symbol.for('#cookies'), $17 = Symbol.for('#__init__'), $35 = Symbol.for('#__initor__'), $36 = Symbol.for('#__inited__'), $18 = Symbol.for('#__hooks__');
...
var $11 = requireDefault$__(require('../../Support/Helpers/isString'/*$path$*/));
var $12 = requireDefault$__(require('querystring'/*$path$*/));
var $13 = requireDefault$__(require('../../Validator/Validator'/*$path$*/));
var $14 = requireDefault$__(require('../../Support/Helpers/wildcard'/*$path$*/));
class FormRequest {
	[$17]($$ = null){
		var $19;
		...
		this.route = ($$ && ($19 = $$.route) !== undefined) ? ($19) : {};
		this.config = $$ ? $$.config : undefined;
		this[$15] = $$ ? $$[$15] : undefined;
		this[$16] = $$ ? $$[$16] : undefined;
		this._rules = ($$ && ($19 = $$._rules) !== undefined) ? ($19) : null;
	...
	*/
	constructor(request,route = {},reply,config){
		...
		this.route = route;
		this.config = config;
		this[$15] = new $3.default(request);
		this[$16] = new $2.default(request,reply);
	}
	...
	*/
	flash(key,value){
		...
		if (!($11.default(key))) { throw TypeError('Expected key to be a string.') };
		
		this.req.session._flashed = Object.assign((($20 = this.req.session._flashed) != null) ? ($20) : {},{
			[key]: value
		});
	...
	*/
	flashMany(object){
		...
		for (let $21 = 0, $22 = Object.keys(object), $23 = $22.length, key, value; $21 < $23; $21++){
			key = $22[$21];value = object[key];
	...
	*/
	signature(){
		...
		if (urlSignature == null || urlSignature == undefined || urlSignature == '') {
			...
			urlSignature = (($24 = this.param('signature')) != null) ? ($24) : null;
		};
	...
	*/
	urlWithoutSignature(){
		...
		return this.signature() ? $12.default.unescape(this.url().split('signature')[0].slice(0,-1)) : this.url();
	}
	...
	*/
	pathIs(path){
		...
		return $14.default(this.route.path,path);
	}
	...
	*/
	routeIs(route){
		...
		return $14.default((($25 = this.route.name) != null) ? ($25) : '',route);
	}
	...
	*/
	all(keys = null){
		...
		if ($10.default(keys) && !($9.default(keys))) {
			
			const all = Object.assign(this.query(),this.body());
			const res = {};
			
			for (let $26 = 0, $27 = iter$__(keys), $28 = $27.length; $26 < $28; $26++) {
				let key = $27[$26];
				res[key] = all[key];
			};
	...
	*/
	input(key = null,default$ = null){
		...
		return (($29 = $7.default($5.default(this.body()),key)) != null) ? ($29) : default$;
	}
	...
	*/
	filled(keys){
		...
		if ($10.default(keys)) { keys = Object.keys(this.body()) };
		
		let filled = {};
		
		for (let $30 = 0, $31 = iter$__(keys), $32 = $31.length; $30 < $32; $30++) {
			let key = $31[$30];
	...
	*/
	query(key = null,default$ = null){
		...
		if ((!key && !(default$))) {
			...
			return (($33 = this.request.query) != null) ? ($33) : {};
		};
		
		let value = this.request.query[key];
		
		value = value ? $12.default.unescape(value) : value;
	...
	*/
	validate(rules = null){
		...
		const body = Object.assign((($34 = this.input()) != null) ? ($34) : {},(files != null) ? files : {});
		
		return $13.default.make(body,requestRules,this.messages());
	}
	...
	*/
	auth(){
		...
		if (onRequestAuth instanceof $1.default) { return onRequestAuth };
