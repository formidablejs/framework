...
const $16 = Symbol.for('#session'), $17 = Symbol.for('#cookies'), $18 = Symbol.for('#__init__'), $36 = Symbol.for('#__initor__'), $37 = Symbol.for('#__inited__'), $19 = Symbol.for('#__hooks__');
...
class FormRequest {
	...
	*/
	routeIs(route){
		...
		return $15.default((($26 = this.route.name) != null) ? ($26) : '',route);
	}
	...
	*/
	input(key = null,default$ = null){
		...
		return (($30 = $7.default($5.default(this.body()),key)) != null) ? ($30) : default$;
	}
	...
	*/
	auth(){
		...
		if ($10.default(onRequestAuth) && $10.default(onRequestAuth().user) && this.user() !== null) {
