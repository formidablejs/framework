...
const $14 = Symbol.for('#session'), $15 = Symbol.for('#cookies'), $16 = Symbol.for('#__init__'), $34 = Symbol.for('#__initor__'), $35 = Symbol.for('#__inited__'), $17 = Symbol.for('#__hooks__');
...
class FormRequest {
	[$16]($$ = null){
		...
		this.route = ($$ && ($18 = $$.route) !== undefined) ? ($18) : {};
		this.config = $$ ? $$.config : undefined;
		this[$14] = $$ ? $$[$14] : undefined;
		this[$15] = $$ ? $$[$15] : undefined;
		this._rules = ($$ && ($18 = $$._rules) !== undefined) ? ($18) : null;
	...
	*/
	flash(key,value){
		...
		this.req.session._flashed = Object.assign((($19 = this.req.session._flashed) != null) ? ($19) : {},{
			[key]: value
		});
	...
	*/
	flashMany(object){
		...
		for (let $20 = 0, $21 = Object.keys(object), $22 = $21.length, key, value; $20 < $22; $20++){
			key = $21[$20];value = object[key];
	...
	*/
	signature(){
		...
		if (urlSignature == null || urlSignature == undefined || urlSignature == '') {
			...
			urlSignature = (($23 = this.param('signature')) != null) ? ($23) : null;
		};
	...
	*/
	routeIs(route){
		...
		return $13.default((($24 = this.route.name) != null) ? ($24) : '',route);
	}
	...
	*/
	all(keys = null){
		...
		if ($9.default(keys) && !($8.default(keys))) {
			...
			for (let $25 = 0, $26 = iter$__(keys), $27 = $26.length; $25 < $27; $25++) {
				let key = $26[$25];
				res[key] = all[key];
			};
	...
	*/
	input(key = null,default$ = null){
		...
		return (($28 = $6.default($4.default(this.body()),key)) != null) ? ($28) : default$;
	}
	...
	*/
	query(key = null,default$ = null){
		...
		if ((!key && !(default$))) {
			...
			return (($32 = this.request.query) != null) ? ($32) : {};
		};
	...
	*/
	validate(rules = null){
		...
		const body = Object.assign((($33 = this.input()) != null) ? ($33) : {},(files != null) ? files : {});
