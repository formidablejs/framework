...
const Ψsession = Symbol.for('#session'), Ψcookies = Symbol.for('#cookies'), Ψ__init__ = Symbol.for('#__init__'), Ψ__initor__ = Symbol.for('#__initor__'), Ψ__inited__ = Symbol.for('#__inited__');
Object.defineProperty(exports, "__esModule", {value: true});

/*body*/
var _$Cookiesφ = requireDefault$__(require('./Cookies'/*$path$*/));
var _$Sessionφ = requireDefault$__(require('./Session'/*$path$*/));
...
class FormRequest {
	[Ψ__init__]($$ = null){
		...
		this[Ψsession] = $$ ? $$[Ψsession] : undefined;
		this[Ψcookies] = $$ ? $$[Ψcookies] : undefined;
	...
	*/
	constructor(request,route = {},reply,config){
		...
		this.route = route;
		this.config = config;
		this[Ψsession] = new _$Sessionφ.default(request);
		this[Ψcookies] = new _$Cookiesφ.default(request,reply);
	}
	...
	session(){
		...
		return this[Ψsession];
	}
	
	cookies(){
		
		return this[Ψcookies];
	}
	...
	*/
	flash(key,value){
		...
		if (!(_$isStringφ.default(key))) { throw TypeError('Expected key to be a string.') };
		
		this.req.session._flashed = Object.assign(((φ = this.req.session._flashed) != null) ? (φ) : {},{
			[key]: value
		});
	...
	*/
	flashMany(object){
		...
		for (let iφ = 0, keysφ = Object.keys(object), lφ = keysφ.length, key, value; iφ < lφ; iφ++){
			key = keysφ[iφ];value = object[key];
	...
	*/
	routeIs(route){
		...
		return _$wildcardφ.default(((φ3 = this.route.name) != null) ? (φ3) : '',route);
	}
	...
	*/
	all(keys = null){
		...
		if (_$isArrayφ.default(keys) && !(_$isEmptyφ.default(keys))) {
			
			const all = Object.assign(this.query(),this.body());
			const res = {};
			
			for (let iφ2 = 0, itemsφ = iter$__(keys), lenφ = itemsφ.length; iφ2 < lenφ; iφ2++) {
				let key = itemsφ[iφ2];
				res[key] = all[key];
			};
	...
	*/
	input(key = null,default$ = null){
		...
		return ((φ4 = _$dotNotationφ.default(_$asObjectφ.default(this.body()),key)) != null) ? (φ4) : default$;
	}
	...
	*/
	filled(keys){
		...
		if (_$isArrayφ.default(keys)) { keys = Object.keys(this.body()) };
		
		let filled = {};
		
		for (let iφ3 = 0, itemsφ2 = iter$__(keys), lenφ2 = itemsφ2.length; iφ3 < lenφ2; iφ3++) {
			let key = itemsφ2[iφ3];
			if (!(_$isEmptyφ.default(this.get(key)))) {
	...
	*/
	query(key = null,default$ = null){
		...
		if ((!key && !(default$))) {
			...
			return ((φ5 = this.request.query) != null) ? (φ5) : {};
		};
	...
	*/
	validate(rules = null){
		...
		const body = Object.assign(((φ6 = this.input()) != null) ? (φ6) : {},(files != null) ? files : {});
