...
class FormRequest {
	...
	*/
	files(){
		...
		return ((φ4 = this.request.rawFiles) != null) ? (φ4) : {};
	}
	...
	*/
	file(name){
		...
		return (this.files()[name] != null) ? this.files()[name] : null;
	}
	...
	*/
	validate(){
		...
		return _$Validatorφ.default.make(Object.assign(((φ5 = this.input()) != null) ? (φ5) : {},((φ6 = this.files()) != null) ? (φ6) : {}),this.getRules(),this.messages());
	}
