...
const $5 = Symbol.for('#__init__'), $6 = Symbol.for('#__patch__'), $11 = Symbol.for('#__initor__'), $12 = Symbol.for('#__inited__'), $7 = Symbol.for('#__hooks__');
...
class File {
	[$6]($$ = {}){
		var $8;
		($8 = $$._object) !== undefined && (this._object = $8);
		
	}
	[$5]($$ = null){
		var $9;
		this._object = ($$ && ($9 = $$._object) !== undefined) ? ($9) : {};
	...
	*/
	get size(){
		...
		return ((($10 = this._object.file.bytesRead) != null) ? ($10) : 0) / 1048576;
	}
