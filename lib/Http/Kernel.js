...
class Kernel {
	...
	async listen(config,errorHandler,hooks,plugins,serverConfig,returnMode){
		var self = this, $27, $28;
	...
	*/
	...
	hasRoutes(router,config){
		...
		for (let $31 = 0, $32 = iter$__($16.default.all()), $33 = $32.length; $31 < $33; $31++) {
			let route = $32[$31];
			$30.push(($10.default(route.action) || ($13.default(route.action) && !($11.default(route.action))) || ($11.default(route.action) && !($13.default(route.action))) || route.action.constructor.name === 'AsyncFunction') ? (
