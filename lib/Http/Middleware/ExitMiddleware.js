...
const $11 = Symbol.for('#__init__'), $12 = Symbol.for('#__patch__'), $24 = Symbol.for('#__initor__'), $25 = Symbol.for('#__inited__'), $13 = Symbol.for('#__hooks__');
...
class ExitMiddleware {
	[$12]($$ = {}){
		var $14;
		($14 = $$.response) !== undefined && (this.response = $14);
	...
	async errorHandler(request,reply,returns = false,shouldReport = true){
		...
		if (this.response instanceof $9.default) {
			...
			if (this.response instanceof $2.default) {
				...
				((($16 = response.exception),delete response.exception, $16));
			} else {
			...
			((($17 = response.exception),delete response.exception, $17));
		};
	...
	*/
	maintenanceModeHandler(request,reply,hooks){
		...
		for (let $18 = 0, $19 = Object.keys(hooks), $23 = $19.length, hook, registeredHooks; $18 < $23; $18++){
			hook = $19[$18];registeredHooks = hooks[hook];
			for (let $20 = 0, $21 = iter$__(registeredHooks), $22 = $21.length; $20 < $22; $20++) {
				let hookHandler = $21[$20];
