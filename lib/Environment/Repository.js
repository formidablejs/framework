...
const $6 = Symbol.for('#__init__'), $10 = Symbol.for('#__initor__'), $11 = Symbol.for('#__inited__'), $7 = Symbol.for('#__hooks__');
...
class Repository {
	[$6]($$ = null){
		var $8;
		this.variables = ($$ && ($8 = $$.variables) !== undefined) ? ($8) : {};
	...
	*/
	constructor(root){
		...
		((($9 = process.env.BUILD_ENV),delete process.env.BUILD_ENV, $9));
